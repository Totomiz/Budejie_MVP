...
import com.zt.tz.budejie_mvp.pro.attention.AttentionFragment;
import com.zt.tz.budejie_mvp.pro.essense.EssenceFragment;
import com.zt.tz.budejie_mvp.pro.mine.MineFragment;
import com.zt.tz.budejie_mvp.pro.newpost.NewpostFragment;
import com.zt.tz.budejie_mvp.pro.publish.PublishFragment;
import com.zt.tz.budejie_mvp.utils.ToastUtil;
...
//                没有选择Tab样式设置为正常
    ...
    class TabItem{
        ...
        private void setMyChecked(boolean isChecked){
            if(imageView != null){
                if (isChecked){
